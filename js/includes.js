...
function addNavBar(selected){
	...
	'<a href="index.html" class="logo navItem"><svg xmlns="http://www.w3.org/2000/svg" width="73" height="13" viewBox="0 0 73.2 12.6"><style type="text/css">'+
...
function addFooter(){
	$('main').append('<footer class="grid__col grid__col--6-of-8">'+
		'<ul class="footerItem">'+
		...
		'<ul class="footerItem">'+
			...
			'<li>Imagine RIT</li>'+
		'</ul>'+
		'<h6 class="footerItem"><span class="copyright">&copy;</span> Team FLUX 2018</h6>'+
	'</footer>');
}